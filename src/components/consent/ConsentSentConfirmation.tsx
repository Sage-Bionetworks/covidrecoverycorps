...
const getConsentButton =(): JSX.Element=>  {
  return (  <div className="buttons--action" style={{flexDirection: "row-reverse"}}>
    <Button
      color="primary"
      variant="contained"
      size="large"
...
const getEHRButton =(from?: string): JSX.Element=>  {
    return (  <div className="buttons--action">
      <Button
            style={{marginTop: "8rem"}}
        color="primary"
        variant="contained"
...
fullWidth
  ...
  return (
    <div>
      {type === 'CONSENT' && (<h2>Thank you for joining the COVID Recovery Corps !</h2>)}
   <div className="consentConfirmation">
      <img src={icon}></img>
      </div>
      <div><p>{text[type]}</p></div>
