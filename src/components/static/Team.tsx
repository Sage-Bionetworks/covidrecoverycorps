       ...
       <div>
         ...
         <div className={introClasses.paperHeaderDiv}>
          <div className={`${classes.paperHeaderText} ${introClasses.paperHeaderText}`}>
            The COVID Recovery Corps is a citizen-powered research study to learn more about COVID-19 and make progress in the global fight.
          </div>
        </div>
        <Grid
          container
          ...
          <Grid item xs={12} md={10} lg={8}>
            <div className={introClasses.paperPanel}>
              ...
              >
                ...
                <Grid item xs={12} sm={6}>
                  <div className={introClasses.paperPanelStepTitle}>
                    Dr. Wendy Chung
                  </div>
                  <div className={introClasses.paperPanelStepBody}>
                    <div className={classes.paddingBottom20}>Dr. Wendy Chung is a co-Principal Investigator based at Columbia University with oversight over clinical operations. Dr Chung is an ABMG board certified clinical and molecular geneticist with 20 years of experience in clinical research, largely for rare diseases.  She leads the Precision Medicine Resource of the Irving Institute at Columbia University and is the principal investigator of the large U.S. study of autism, SPARK.  </div>
                    <div className={classes.paddingBottom20}>She works with many patient and family led organizations to develop better supports and treatments for rare diseases and was recognized by the National Organization of Rare Disorders with the Rare Impact Award in 2019.  She was recently featured in the documentary, The Gene: An Intimate History.</div>
                    <div>For more information, please visit <a href="https://www.columbia.edu">www.columbia.edu</a>.</div>
                  </div>
                  <ColumbiaLogo />
                </Grid>
              </Grid>
        ...
        >
          <Grid item xs={12} sm={8} lg={6}>
            <div className={classes.quoteTextContainer}>
              <div className={introClasses.paperPanelStepTitle}>
                “As a COVID-19 survivor community, we can give researchers a real shot at understanding - and beating - this disease. Own your recovery. Give back, support science, and save lives!”
              </div>
              <div>
        ...
        <div className={classes.greenBox}>
          <Grid item xs={12} md={10} lg={8}>
            <div className={classes.greenBoxTitleText}>
