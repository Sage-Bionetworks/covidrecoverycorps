...
import { ListItem, List, Divider, Hidden, Grid, Button, Link } from '@material-ui/core'
...
export const TopNav: React.FunctionComponent<TopNavProps> = (
  ...
  const drawer = <div>
    <List>
      ...
      <Link href={privacyPolicyLink} onClick={handleDrawerToggle} className={classes.navBarLink} target='_blank'>
        <ListItem button>
          Privacy Policy
        </ListItem>
      </Link>
...
const fullScreenNavBar = <div>
  ...
  <Link href={privacyPolicyLink} className={classes.fullNavBarLink} target='_blank'>
      Privacy Policy
  </Link>
  {props.token && (
